 ...
 */
// isPioneerPhase moved to core/ColonyTargets - a colony's target counts are a fact about
// the colony, not a policy of whichever module asks. See that file's header.
 ...
 */
// getCreepTargets moved to core/ColonyTargets - a colony's target counts are a fact about
// the colony, not a policy of whichever module asks. See that file's header.
...
// needsScout moved to core/ColonyTargets - a colony's target counts are a fact about
// the colony, not a policy of whichever module asks. See that file's header.

// countRoomsNeedingScan moved to core/ColonyTargets - it defines the SCOUT target, so
// it belongs with the rest of the target computation.
 ...
 */
// getRemoteBuilderTarget moved to core/ColonyTargets - a colony's target counts are a fact about
// the colony, not a policy of whichever module asks. See that file's header.
